...
type MegaPanelKey = "products" | "solutions" | "developers" | "resources";
      ...
      <AnimatePresence>
        {activePanel ? (
          <motion.div
            ...
            className="hidden border-t border-[#d9e3dc] bg-[#fbfcfa]/96 shadow-[0_24px_80px_rgba(24,36,30,0.12)] backdrop-blur-2xl lg:block"
          >
            <MegaPanel
  ...
  return (
    <div className="space-y-5 px-4 py-5">
      ...
      <div className="space-y-2">
        {MEGA_PANEL_KEYS.map((key) => {
          const panel = copy.header.mega[key];
          ...
          return (
            ...
            >
              ...
              <div className="border-t border-[#edf1ee] px-3 py-2">
                {panel.columns.flatMap((column) => column.items).map((item) => (
                  <a
                    key={item.title}
                    href={item.href}
                    onClick={onNavigate}
