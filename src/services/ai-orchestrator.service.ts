...
function buildOrchestratorPrompt(input: {
  ...
  return [
    ...
    "- Do not plan create_deal, update_deal, or create_calendar_event while required data-collection fields are still missing (unless the customer already gave those values in this turn via update_collected_fields).",
    ...
    "- sales intent: prefer update_deal when an open deal exists; otherwise create_deal once, plus create_task/add_note when needed and required collection fields are complete",
