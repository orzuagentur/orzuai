...
export const CONTACTS_MESSAGES = {
  ...
  customFieldIconLabel: "Icon",
  customFieldDialogTitle: "Add custom field",
  customFieldDialogDescription:
    "Choose a name and icon, then enter the value for this contact.",
  customFieldEditTitle: "Edit custom field",
  customFieldSaved: "Custom field saved.",
  customFieldRemoved: "Custom field removed.",
  customFieldSaveFailed: "Unable to save custom field.",
  customFieldInvalidIcon: "Choose a valid icon for this field.",
  customFieldNameRequired: "Enter a field name.",
  ...
  notesDeleted: "Notes cleared.",
  clientDescriptionTitle: "Client description",
  clientDescriptionHint:
    "Who the client is and what they want. You can edit it; the AI Agent also updates it during chats.",
  clientDescriptionEmpty:
    "No description yet. Add one here, or the AI will fill it in during conversations.",
  clientDescriptionPlaceholder:
    "e.g. Hotel owner looking for a booking demo next week…",
  clientDescriptionSaved: "Client description saved.",
  editClientDescription: "Edit client description",
  refreshClientDescription: "Refresh",
  ...
  aiSummaryLabel: "Client description",
  generateInsights: "Refresh client description",
  generatingInsights: "Analyzing…",
  insightsGenerated: "Client description updated.",
  insightsFailed: "Unable to update client description. Please try again.",
  insightsUnavailable: "Client description requires AI API configuration.",
  ...
  markDealOpen: "Mark open",
  markDealWon: "Mark won",
  markDealLost: "Mark lost",
