export const INSTAGRAM_MESSAGES = {
  ...
  notConfigured:
    "Instagram is not configured yet. Add NEXT_PUBLIC_META_APP_ID, NEXT_PUBLIC_INSTAGRAM_EMBEDDED_SIGNUP_CONFIG_ID, and WHATSAPP_APP_SECRET (Meta App Secret) to your environment.",
