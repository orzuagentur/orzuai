...
export const PLATFORM_COPILOT_MESSAGES = {
  ...
  modeFullAccessHint: "Сделки, календарь, контакты, сообщения, база знаний, каналы",
  ...
  modeFullAccessConfirmBody:
    "orzuAI сможет предлагать реальные действия: создать сделку, добавить событие в календарь, отправить сообщение клиенту, удалить контакт, изменить базу знаний, включить канал, создать календарь. Каждое действие потребует отдельного подтверждения кнопкой.",
  ...
  examples: [
    ...
    "Создай сделку для последнего лида",
    "Добавь встречу завтра в 15:00 в календарь",
