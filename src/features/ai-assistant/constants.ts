export const AI_ASSISTANT_MESSAGES = {
  ...
  voiceCallAgentTitle: "Call AI agent",
  voiceCallAgentHint:
    "Turn on AI for phone calls. Chat messages always stay text.",
  voiceCallNumbersTitle: "Numbers AI answers",
  voiceCallNumbersHint: "Pick which Twilio number the AI voice agent answers.",
  voiceCallVoiceTitle: "Call voice",
  voiceCallVoiceHint: "Compact ElevenLabs voices for phone calls only.",
  ...
  voiceAgentNotConfigured:
    "Add ELEVENLABS_API_KEY to the server environment to load voices.",
  voiceAgentSave: "Save",
  voiceAgentSaved: "Call voice settings saved.",
  voiceAgentSaveFailed: "Unable to save call voice settings.",
  voiceAgentSelectVoiceError: "Select a voice before enabling call AI.",
  ...
  agentAnalyticsConversationsHint: "Conversations where this agent handled replies.",
