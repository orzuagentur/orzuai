...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: "/content", label: "Контент сайта", icon: PenLineIcon },
      { href: "/email-center", label: "Email Center", icon: MailIcon },
      { href: "/marketing", label: "Маркетинг", icon: RocketIcon },
      { href: "/billing", label: "Биллинг", icon: CreditCardIcon },
      { href: "/billing/plans", label: "Тарифы", icon: CreditCardIcon },
      { href: "/billing/products", label: "Продукты", icon: PackageIcon },
      { href: "/audit", label: "Аудит", icon: ScrollTextIcon },
      {
        href: "/error-intelligence",
        label: "Errors",
